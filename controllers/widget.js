$.create = function (e){
	...
	$.ripple.setTop(e.y-(rippleWidth/2));
	$.ripple.setLeft(e.x-(rippleWidth/2));
	$.ripple.setWidth(rippleWidth);
	$.ripple.setHeight(rippleHeight);
	$.ripple.setBorderRadius(rippleWidth/2);
	$.ripple.setBackgroundColor("rgba(255,255,255,0.40)");
	$.ripple.setTransform(Titanium.UI.create2DMatrix().scale(0));
	$.ripple.setZindex(999);
	$.ripple.setOpacity(0);
